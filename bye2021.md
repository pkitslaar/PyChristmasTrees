...
* The `P` function is the "workhorse" of this code. It generates a list of `(y,x)` positions in a rectangular grid. The grid is offset at the position `(h,w)` and has dimensions of *height x width* of `H*W`.
